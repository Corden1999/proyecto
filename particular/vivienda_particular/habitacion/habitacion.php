...
<head>
    <meta charset="UTF-8">
    <title>Junteate - Habitaciones</title>
    <style>
        body {
...
<body>
    ...
    <div class="panel-habitacion">
        <h2>Panel de Control de Habitaciones</h2>
        <p>Bienvenido al panel de control de habitaciones. Desde aquí podrás gestionar tus habitaciones, ya sea para alquilar o arrendar. Utiliza el menú superior para acceder a todas las funcionalidades disponibles.</p>
    </div>
