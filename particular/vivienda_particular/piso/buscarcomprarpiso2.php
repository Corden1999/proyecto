...
<body>
    ...
    echo "<div class='welcome-container'>
     ...
     $sql = "SELECT * FROM pisos WHERE (direccion = '$direccion' OR localidad = '$localidad' OR provincia = '$provincia' OR precio = '$precio') AND tipo = 'venta' AND disponible = 'si'";
            ...
            for ($i=0; $i<$nfilas; $i++) {
                ...
                if ($fila['id_usuario'] == $_SESSION['id_usuario']) {
                    ...
                    if ($cuenta && $cuenta['saldo'] >= $fila['precio']) {
                        echo "<form action='comprarpiso2.php' method='POST'>";
