...
<body>
    ...
    if (mysqli_query($conn, $sql)) {
        echo "<div class='result-container'>
                <div class='success-text' style='color: #ae8b4f; font-size: 24px; margin-bottom: 20px; text-align: center;'>Piso actualizado con éxito</div>
                <a href='editarmispisos.php' style='background-color: #ae8b4f; color: #000000; padding: 12px 25px; border-radius: 25px; text-decoration: none; font-weight: bold;'>Volver a mis pisos</a>
              </div>";
    } else {
        echo "<div class='result-container'>
