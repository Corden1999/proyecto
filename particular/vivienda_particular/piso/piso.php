...
<body>
    ...
    <nav class="menu">
        ...
        <div class="dropdown">
            <button onclick="location.href='arrendarpiso.php'">Arrendar / venderpiso</button>
            <div class="dropdown-content">
    ...
    <div class="panel-piso">
        <h2>Panel de Control de Pisos</h2>
        <p>Bienvenido al panel de control de pisos. Desde aquí podrás gestionar tus pisos, ya sea para alquilar o arrendar. Utiliza el menú superior para acceder a todas las funcionalidades disponibles.</p>
    </div>
