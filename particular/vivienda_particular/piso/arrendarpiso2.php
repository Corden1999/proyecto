...
$instruccion = "INSERT INTO Pisos (direccion, localidad, provincia, codigo_postal, precio, descripcion, disponible, tipo, foto, id_usuario) 
...
if (mysqli_query($conexion, $instruccion)) {
    echo "Piso insertado con éxito.";
} else {
    echo "Error al insertar piso: " . mysqli_error($conexion);
}
...
<head>
    <meta charset="UTF-8">
    <title>Junteate - Procesar Piso</title>
    <style>
        body {
...
<body>
    ...
    <div class="form-container">
        <h2>Piso insertado con éxito</h2>
        <div class="back-button">
            <a href="arrendarpiso.php">Volver al formulario</a>
        </div>
    </div>
</body>
</html>