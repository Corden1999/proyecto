...
// Enviar consulta
$instruccion = "SELECT * FROM Pisos WHERE tipo = 'alquiler' and disponible = 'si'";
...
<head>
    <meta charset="UTF-8">
    <title>Junteate - Pisos en alquiler</title>
    <style>
        body {
    ...
    <div class="pisos-container">
        ...
        if ($nfilas > 0) {
            for ($i=0; $i<$nfilas; $i++) {
                ...
                echo "<div class='piso-precio'>" . $resultado['precio'] . "€/mes</div>";
                ...
                if ($resultado['id_usuario'] == $_SESSION['id_usuario']) {
                    ...
                    if ($cuenta && $cuenta['saldo'] >= $resultado['precio']) {
                        echo "<form action='alquilarpiso2.php' method='POST'>";
            ...
            echo "<div class='no-pisos'>No hay pisos disponibles para alquilar</div>";
        }
