...
if (!isset($_GET['id_usuario'])) {
    header("Location: mensajeparticular.php");
    exit();
}
...
<body>
    ...
    <div class="chat-container">
        ...
        <form action="chat.php?id_usuario=<?php echo $id_otro_usuario; ?>" method="POST" class="form-container">
        ...
        <a href="mensajeparticular.php" class="volver-button">Volver a Mensajes</a>
    </div>
