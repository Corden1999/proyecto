...
// Enviar consulta
$sql = "SELECT * FROM Locales WHERE (direccion LIKE '%$direccion%' OR localidad LIKE '%$localidad%' OR provincia LIKE '%$provincia%' OR precio <= '$precio') AND tipo = 'alquiler' AND disponible = 'si'";
...
<head>
    <meta charset="UTF-8">
    <title>Junteate - Buscar Locales en alquiler</title>
    <style>
        body {
