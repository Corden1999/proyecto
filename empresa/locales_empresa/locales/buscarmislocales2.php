...
<body>
    ...
    $sql = "SELECT * FROM Locales WHERE id_usuario = " . $_SESSION['id_usuario'] . " AND (direccion = '$direccion' OR localidad = '$localidad' OR provincia = '$provincia' OR codigo_postal = '$codigo_postal' OR precio = '$precio' OR tipo = '$tipo')";
