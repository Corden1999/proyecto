...
<head>
    <meta charset="UTF-8">
    <title>Junteate - Buscar Locales en venta</title>
    <style>
        body {
...
<div class="header">
    ...
    $sql = "SELECT * FROM Locales WHERE (direccion = '$direccion' OR localidad = '$localidad' OR provincia = '$provincia' OR precio = '$precio') AND tipo = 'venta' AND disponible = 'si'";
     $resultado = mysqli_query($conexion, $sql)
        ...
        if ($nfilas > 0) {
            ...
            for ($i=0; $i<$nfilas; $i++) {
                ...
                echo "<div class='piso-propietario' style='color: #ae8b4f;'>Propietario: " . $propietario['nombre'] . "</div>";
                ...
                if ($cuenta && $cuenta['saldo'] >= $fila['precio']) {
                    echo "<form action='procesarcomprarlocal.php' method='POST'>";
            ...
            echo "<div class='no-pisos'>No hay locales que coincidan con los criterios de búsqueda</div>";
        }
