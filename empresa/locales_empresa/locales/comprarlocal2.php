...
if (!$id_local || !$precio) {
    header("Location: comprarlocal.php");
    exit();
}
...
<head>
    <meta charset="UTF-8">
    <title>Junteate - Detalles de Compra de Local</title>
    <style>
        body {
    ...
    <div class="local-container">
        <div class="local-card">
            ...
            <div class="botones-container">
                <form action="procesarcompra.php" method="POST" style="display: inline;">
                    <input type="hidden" name="id_local" value="<?php echo $local['id_local']; ?>">
                    <input type="hidden" name="precio" value="<?php echo $local['precio']; ?>">
                    <button type="submit" class="comprar-button">Confirmar Compra</button>
                </form>

                <form action="../../../sesiones/chatempresa.php" method="GET" style="display: inline;">
                    <input type="hidden" name="id_usuario" value="<?php echo $local['id_usuario']; ?>">
        ...
        <div class="hipoteca-container">
            ...
            <div class="hipoteca-form">
                <div class="form-group">
                    ...
                    <input type="number" id="precio_inmueble" value="<?php echo $local['precio']; ?>" readonly>
                </div>
                <div class="form-group">
        ...
        <a href="comprarlocal.php" class="volver-button">Volver a Locales en Venta</a>
    </div>
