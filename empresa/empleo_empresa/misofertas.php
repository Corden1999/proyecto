...
// Enviar consulta para obtener las ofertas del usuario actual
$id_usuario = $_SESSION['id_usuario'];
$instruccion = "SELECT e.*, COUNT(ie.id_inscripcion) as num_candidatos 
                FROM Empleos e 
    ...
    <div class="ofertas-container">
        ...
        if ($nfilas > 0) {
            for ($i=0; $i<$nfilas; $i++) {
                ...
                echo "<div class='candidatos-info'>Candidatos inscritos: " . $resultado['num_candidatos'] . "</div>";
                
                // Botón para ver candidatos
                if ($resultado['num_candidatos'] > 0) {
