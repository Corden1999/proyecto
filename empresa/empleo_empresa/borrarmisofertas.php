...
// Enviar consulta
$instruccion = "SELECT * FROM Empleos WHERE id_usuario = " . $_SESSION['id_usuario'];
    ...
    <div class="ofertas-container">
        ...
        if ($nfilas > 0) {
            for ($i=0; $i<$nfilas; $i++) {
                ...
                echo "<form action='borrarmisofertas2.php' method='POST' class='delete-form'>";
                echo "<input type='hidden' name='id_empleo' value='" . $resultado['id_empleo'] . "'>";
                echo "<button type='submit' class='delete-button' onclick='return confirm(\"¿Estás seguro de que quieres eliminar esta oferta?\");'>Eliminar</button>";
                echo "</form>";
                echo "</div>";
            }
        } else {
            echo "<div class='no-ofertas'>No tienes ofertas de empleo publicadas</div>";
        }
